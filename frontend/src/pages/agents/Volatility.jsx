...
export default function Volatility() {
  ...
  useEffect(() => {
    setHtml(localStorage.getItem('volatility_html') || '')
  }, [])

  return (
    <>
      <SharedHeader title="Volatility Agent" subtitle="Analyzing volatility and variability factors in your business problem" />
      <div className="container">
        ...
        {html && <SectionTitle title="Volatility Analysis" />}
        {html && (
        ...
        <ReportActions agentDisplayName="Volatility Agent" account={form.account} htmlContent={html} />
