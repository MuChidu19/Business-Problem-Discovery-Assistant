      ...
      <div className="container">
        ...
        {html && (
          <div style={{margin:'8px 0 0', textAlign:'center', opacity:0.8}}>
            AI-generated for <strong>{form.account || 'Unknown Company'}</strong> ({form.industry || 'Unknown Industry'}).
          </div>
        )}
        <div style={{marginTop: 16}} className="card fade-up">
          <div dangerouslySetInnerHTML={{ __html: html }} />
        </div>
        <ReportActions agentDisplayName="Current System Agent" account={form.account} htmlContent={html} />
